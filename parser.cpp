...
int main(int argc, char const *argv[]){
	...
	int perc64x64, perc64x32, perc64x16, perc64x8, perc32x64, perc32x32, perc32x16, perc32x8, perc16x64, perc16x32, perc16x16, perc16x8, perc8x64, perc8x32, perc8x16, perc8x8;
	...
	ofstream arquivo3;
	arquivo1.open("BlowingBubbles_100.csv", ios::in);
	arquivo2.open("BlowingBubbles_20.csv", ios::in);
	arquivo3.open("BlowingBubbles_20_result.csv", ios::out);
