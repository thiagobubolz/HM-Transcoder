...
BitRate = ["3248470","1949082","909546","603813","4845850","5312382"]
...
for i in range(len(cfgArray)):
	...
	execc = " -c cfg/encoder_randomaccess_main.cfg -c cfg/per-sequence/" + cfgArray[i] + ".cfg " + "--BitstreamFile=" + cfgArray[i] + "_40.bin" + " --TargetBitrate=" + BitRate[i] + " > " + cfgArray[i] + "_40info.txt"

	exe = execcod + execc

	rename = "mv traceMatlab.csv " + cfgArray[i] + "_40.csv"
